...
public final class NacosConfigUtil {
    ...
    public static final String COMMON_DATA_ID_PREFIX = "sentinel-";
...
//                    System.out.println(rule2.getClass());
        ...
        // 存储，给微服务使用
        String dataId = genDataId(COMMON_DATA_ID_PREFIX, app, postfix);
        configService.publishConfig(
                dataId,
                NacosConfigUtil.GROUP_ID,
                JSONUtils.toJSONString(ruleForApp), ConfigType.JSON.getType()
        );
...
//                NacosConfigUtil.GROUP_ID,
//                JSONUtils.toJSONString(rules), ConfigType.JSON.getType()
//        );
    }
...
//                genDataId(appName, postfix) + DASHBOARD_POSTFIX,
                genDataId(COMMON_DATA_ID_PREFIX, appName, postfix),
                NacosConfigUtil.GROUP_ID,
                3000
        );
    ...
    private static String genDataId(String prefix, String appName, String postfix) {
        return prefix + appName + postfix;
    }
}
